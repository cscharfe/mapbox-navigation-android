...
public class FeedbackBottomSheet extends BottomSheetDialogFragment implements FeedbackClickListener.ClickCallback,
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (primaryColor == 0) {
      primaryColor = ContextCompat.getColor(getContext(), R.color.mapbox_feedback_bottom_sheet_primary);
      secondaryColor = ContextCompat.getColor(getContext(), R.color.mapbox_feedback_bottom_sheet_secondary);
      textColor = ContextCompat.getColor(getContext(), R.color.mapbox_feedback_bottom_sheet_text);
    }
  }
